...
# =============================================================================
    ...
    def full_train_nn(self, model_class, best_params):
        ...
        plt.title(f'{model_class.__name__} Training Curve', fontsize=20)
    ...
    def generate_regression_plots(self, y_true, y_pred, model_name):
        ...
        # Plot the histogram
        n, bins, patches = plt.hist(residuals, bins=30, density=True, color='blue', alpha=0.7, edgecolor='black')
    ...
    def evaluate_best_model_on_test(self, model_name):
        ...
        if model_name == "Ensemble":
            ...
            preds = self.predict_ensemble(self.X_test_scaled)
